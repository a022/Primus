...
if ( ! function_exists( 'primus_setup' ) ) :
	...
	function primus_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'primus' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'primus_custom_background_args', array(
...
function primus_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'primus' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'primus' ),
...
function primus_scripts() {
	...
	wp_enqueue_script( 'primus-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
